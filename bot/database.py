...
ffmpeg = "-map 0:v -map 0:a? -map 0:s:0? -c:v libx265 -pix_fmt yuv420p -x265-params 'no-info=1' -metadata title='Encoded By @SamXD7' -c:a libfdk_aac -ac 2 -profile:a aac_he_v2 -movflags +faststart -threads 2"
